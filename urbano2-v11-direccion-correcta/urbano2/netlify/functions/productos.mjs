  ...
  try {
    ...
    if (req.method === "POST") {
      ...
      const nuevo = {
        ...
        masVendido: !!body.masVendido,
        descuento: Math.min(Math.max(Number(body.descuento) || 0, 0), 95),
    ...
    if (req.method === "PUT") {
      ...
      if (body.masVendido !== undefined) p.masVendido = !!body.masVendido;
      if (body.descuento !== undefined) p.descuento = Math.min(Math.max(Number(body.descuento) || 0, 0), 95);
